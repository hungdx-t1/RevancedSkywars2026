                    ...
                    if (particles != null) {
                        for (String part : particles) {
                            ...
                            if (parts.length == 6
                                ...
                                effects.add(new ParticleEffect(parts[0].toUpperCase(), Float.parseFloat(parts[1]), Float.parseFloat(parts[2]), Float.parseFloat(parts[3]), Integer.parseInt(parts[4]), Integer.parseInt(parts[5])));
                            } else {
